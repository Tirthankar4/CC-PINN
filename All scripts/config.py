...
class VisualizationConfig:
    ...
    training_only: bool = True  # If True, skip all post-training visualization
...
class SimulationConfig:
    ...
    def from_dict(cls, d: dict) -> "SimulationConfig":
        ...
        if "random_seed" in d and "power_spectrum" not in d:
            ...
            d.setdefault("power_spectrum", {}).setdefault(
                "random_seed", d.pop("random_seed")
            )
        ...
        if "perturbation_type" in d and "initial_condition" not in d:
            ...
            d.setdefault("initial_condition", {}).setdefault(
                "mode", d.pop("perturbation_type")
            )
...
TRAINING_ONLY = CONFIG.visualization.training_only
